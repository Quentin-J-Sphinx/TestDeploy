import ouvrir from '../../components/Reservation/logos/ouvrir.png'
        ...
        <>
            <section className='description'>
                <div className='description-left'>
                    ...
                    {/* <div className='description-left-third'>
                    <p>Perfectionnez votre approche de la dégustation, <span className='description-bold'>approfondissez vos connaissances sur le Rhum.</span></p> 
                    <p>Découvrez les cuvées exclusives et exceptionnelles du plus grand bar à rhum de France. <br></br> (6 cuvées proposées). </p>
                    <ul className='description-left-third-ul'>
                        <li>Les ateliers sont <span className='description-bold'>non remboursables.</span></li>
                        <li>La direction se réserve le droit de <span className='description-bold'>refuser l'accès à la dégustation,</span> s'il y a plus de <span className='description-bold'>15 min de retard.</span></li>
                        <li><span className='description-bold'>Modification</span> du créneau possible jusqu'à <span className='description-bold'>72h avant.</span> Sous réserve de disponibilité.</li>
                    </ul>
                </div> */}
            ...
            <section className='avis'>
                ...
                <div className='avis-third'>
                    <div className='avis-third-div'>
                        ...
                        <button>Contacter l'établissement</button>
                    </div>
                </div>
            </section>
            )}
